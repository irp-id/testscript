...
test -e build/result1 && mkdir -p build/ProductBuild/internal-artifact/$1/result &&
cp -R build/result1/*.txt build/ProductBuild/internal-artifact/$1/result || echo skip result1 &&
